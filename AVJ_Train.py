...
data_dir='./data/training/frames'
data_csv='./data/training/ch234.csv'
...
img_sel = 100
simg, slabel = my_transform(torch.tensor(trainData[img_sel]), trainLabel[img_sel])
print(simg.shape)
show_img(trainData[img_sel], trainLabel[img_sel][0:2], trainLabel[img_sel][2:4])
show_img(simg, slabel[0:2], slabel[2:4])
print(pts1[img_sel])
print(pts2[img_sel])
print(trainLabel[img_sel])
